 ...
 * @param { string } value
 */
var isPostcode = function (value) { return /^(0[1-7]|1[0-356]|2[0-7]|3[0-6]|4[0-7]|5[1-7]|6[1-7]|7[0-5]|8[013-6])\d{4}$/g.test(value); };
/**
 ...
 * @param { string } value
 */
var isHttpAndPort = function (value) { return /^((ht|f)tps?:\/\/)?[\w-]+(\.[\w-]+)+:\d{1,5}\/?$/g.test(value); };
/**
 * 验证网址(支持端口和"?+参数"和"#+参数)
 *  @param { string } value
 */
var isRightWebsite = function (value) { return /^(((ht|f)tps?):\/\/)?[\w-]+(\.[\w-]+)+([\w.,@?^=%&:/~+#-]*[\w@?^=%&/~+#-])?$/g.test(value); };
/**
 * 验证统一社会信用代码
 *  @param { string } value
 */
var isCreditCode = function (value) { return /^[0-9A-HJ-NPQRTUWXY]{2}\d{6}[0-9A-HJ-NPQRTUWXY]{10}$/g.test(value); };
/**
 * 验证版本号格式必须为X.Y.Z
 *  @param { string } value
 */
 ...
 *  @param { string } value
 */
var isImageUrl = function (value) { return /^https?:\/\/(.+\/)+.+(\.(gif|png|jpg|jpeg|webp|svg|psd|bmp|tif))$/i.test(value); };
/**
 * 验证中文姓名
 * @param { string } value
 */
 ...
 * @param { string } value
 */
var isEnglishName = function (value) { return /(^[a-zA-Z]{1}[a-zA-Z\s]{0,20}[a-zA-Z]{1}$)/g.test(value); };
/**
 * 验证车牌号(新能源)
 * @param { string } value
 */
var isLicensePlateNumberNER = function (value) { return /[京津沪渝冀豫云辽黑湘皖鲁新苏浙赣鄂桂甘晋蒙陕吉闽贵粤青藏川宁琼使领 A-Z]{1}[A-HJ-NP-Z]{1}(([0-9]{5}[DF])|([DF][A-HJ-NP-Z0-9][0-9]{4}))$/g.test(value); };
/**
 * 验证车牌号(非新能源)
 * @param { string } value
 */
var isLicensePlateNumberNNER = function (value) { return /^[京津沪渝冀豫云辽黑湘皖鲁新苏浙赣鄂桂甘晋蒙陕吉闽贵粤青藏川宁琼使领 A-Z]{1}[A-HJ-NP-Z]{1}[A-Z0-9]{4}[A-Z0-9挂学警港澳]{1}$/g.test(value); };
/**
 * 验证车牌号(新能源+非新能源)
 * @param { string } value
 */
 ...
 * @param { string } value
 */
var isMPStrict = function (value) { return /^(?:(?:\+|00)86)?1(?:(?:3[\d])|(?:4[5-7|9])|(?:5[0-3|5-9])|(?:6[5-7])|(?:7[0-8])|(?:8[\d])|(?:9[1|8|9]))\d{8}$/g.test(value); };
/**
 ...
 * @param { string } value
 */
var isPassport = function (value) { return /(^[EeKkGgDdSsPpHh]\d{8}$)|(^(([Ee][a-fA-F])|([DdSsPp][Ee])|([Kk][Jj])|([Mm][Aa])|(1[45]))\d{7}$)/g.test(value); };
/**
 * 验证中文/汉字
 * @param { string } value
 */
