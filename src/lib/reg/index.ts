 ...
 * @param { string } value
 */
const isNoWord = (value:string) => /^[^A-Za-z]*$/g.test(value)

/**
 * 验证中文和数字
 * @param { string} value
 */
const isCHNAndEN = (value:string) =>
 ...
 * @param { string } value
 */
const isWeChatNum = (value:string) => /^[a-zA-Z][-_a-zA-Z0-9]{5,19}$/g.test(value)

/**
 * 验证16进制颜色
 * @param { string } value
 */
const isColor16 = (value:string) => /^#?([a-fA-F0-9]{6}|[a-fA-F0-9]{3})$/g.test(value)

/**
 * 验证火车车次
 * @param { string } value
 */
const isTrainNum = (value:string) => /^[GCDZTSPKXLY1-9]\d{1,4}$/g.test(value)

/**
 * 验证必须带端口号的网址(或ip)
 * @param { string } value
 */
const isHttpAndPort = (value:string) =>
 ...
 *  @param { string } value
 */
const isRightWebsite = (value:string) =>
 ...
 *  @param { string } value
 */
const isCreditCode = (value:string) =>
 ...
 *  @param { string } value
 */
const isVersion = (value:string) => /^\d+(?:\.\d+){2}$/g.test(value)
 ...
 * @param { string } value
 */
const isChineseName = (value:string) => /^(?:[\u4e00-\u9fa5·]{2,16})$/g.test(value)
 ...
 * @param { string } value
 */
const isLicensePlateNumberNER = (value:string) =>
 ...
 * @param { string } value
 */
const isLicensePlateNumberNNER = (value:string) =>
 ...
 * @param { string } value
 */
const isLicensePlateNumber = (value:string) =>
 ...
 * @param { string } value
 */
const isMPRelaxed = (value:string) => /^(?:(?:\+|00)86)?1[3-9]\d{9}$/g.test(value)

/**
 * 验证email(邮箱) 收录自 有赞 vant 的 https://github.com/youzan/vant/blob/2.x/src/utils/validate/email.ts
 * @param { string } value
 */
const isEmail = function (value:string) {
  const reg =
 ...
 * @param { string } value
 */
const isLandlineTelephone = (value:string) => /\d{3}-\d{8}|\d{4}-\d{7}/g.test(value)

/**
 * 验证护照（包含香港、澳门）
 * @param { string } value
 */
const isPassport = (value:string) =>
 ...
 * @param { string } value
 */
const isDecimal = (value:string) => /^\d+\.\d+$/g.test(value)
 ...
 * @param { string } value
 */
const isNumberStr = (value:string) => /^\d{1,}$/g.test(value)
 ...
 * @param { string } value
 */
const isQQNum = (value:string) => /^[1-9][0-9]{4,10}$/g.test(value)

/**
 * 验证数字和字母组成
 * @param { string } value
 */
const isNumAndStr = (value:string) => /^[A-Za-z0-9]+$/g.test(value)

/**
 * 验证英文字母
 * @param { string } value
 */
const isEnglish = (value:string) => /^[a-zA-Z]+$/g.test(value)

/**
 * 验证大写英文字母
 * @param { string } value
 */
const isCapital = (value:string) => /^[A-Z]+$/g.test(value)

/**
 * 验证小写英文字母
 * @param { string } value
 */
const isLowercase = (value:string) => /^[a-z]+$/g.test(value)

/**
 * 验证手机机身码(IMEI)
 * @param { string } value
 */
const isIMEI = (value:string) => /^\d{15,17}$/g.test(value)

/**
 * 验证统一社会信用代码(宽松匹配)(15位/18位/20位数字/字母)
 * @param { string } value
 */
const isCreditCode2 = (value:string) =>
 ...
 * @param { string } value
 */
const isXunleiUrl = (value:string) => /^thunderx?:\/\/[a-zA-Z\d]+=$/g.test(value)

/**
 * 验证ed2k链接(宽松匹配)
 * @param { string } value
 */
const isEd2kUrl = (value:string) => /^ed2k:\/\/\|file\|.+\|\/$/g.test(value)

/**
 * 验证磁力链接
 * @param { string } value
 */
const isMagnetUrl = (value:string) =>
 ...
 * @param { string } value
 */
const isLinuxHiddenPath = (value:string) => /^\/(?:[^/]+\/)*\.[^/]*/g.test(value)

/**
 * 验证linux文件夹路径
 * @param { string } value
 */
const isLinuxFolderPath = (value:string) => /^\/(?:[^/]+\/)*$/g.test(value)

/**
 * 验证linux文件路径
 * @param { string } value
 */
const isLinuxFilePath = (value:string) => /^\/(?:[^/]+\/)*[^/]+$/g.test(value)

/**
 * 验证window"文件夹"路径
 * @param { string } value
 */
const isWindowFolderPath = (value:string) => /^[a-zA-Z]:\\(?:\w+\\?)*$/g.test(value)

/**
 * 验证window文件路径
 * @param { string } value
 */
const isWindowFilePath = (value:string) =>
 ...
 * @param { string } value
 */
const isStockCode = (value:string) =>
 ...
 * @param { string } value
 */
const isHtmLComment = (value:string) => /^<!--[\s\S]*?-->$/g.test(value)

/**
 * 验证md5格式(32位)
 * @param { string } value
 */
const isMd532 = (value:string) => /^([a-f\d]{32}|[A-F\d]{32})$/g.test(value)
 ...
 * @param { string } value
 */
const is24HourTime = (value:string) =>
 ...
 * @param { string } value
 */
const is12HourTime = (value:string) =>
 ...
 * @param { string } value
 */
const isCurrency = (value:string) => /^-?\d+(,\d{3})*(\.\d{1,2})?$/g.test(value)

/**
 * 验证数字/货币金额 (只支持正数、不支持校验千分位分隔符)
 * @param { string } value
 */
const isCurrency2 = (value:string) =>
 ...
 * @param { string } value
 */
const isBankCard = (value:string) => /^[1-9]\d{9,29}$/g.test(value)
 ...
 * @param { string } value
 */
const isAccount = (value:string) => /^[a-zA-Z]\w{4,15}$/g.test(value)

/**
 * 验证html标签(宽松匹配)
 * @param { string } value
 */
const isHtmlTag = (value:string) => /<(\w+)[^>]*>(.*?<\/\1>)?/g.test(value)

/**
 * 验证用户名校验，4到16位（字母，数字，下划线，减号）
 * @param { string } value
 */
const isUsername = (value:string) => /^[a-zA-Z0-9_-]{4,16}$/g.test(value)
 ...
 * @param { string } value
 */
const isJvavaPackName = (value:string) =>
 ...
 * @param { string } value
 */
const isHKIdCard = (value:string) => /^[a-zA-Z]\d{6}\([\dA]\)$/g.test(value)

/**
 * 验证澳门身份证
 * @param { string } value
 */
const isMacauIdCard = (value:string) => /^[1|5|7]\d{6}[(\d)]{3}$/g.test(value)

/**
 * 验证台湾身份证
 * @param { string } value
 */
const isTWIdCard = (value:string) => /^[a-zA-Z][0-9]{9}$/g.test(value)
