 ...
 * @param { string } value
 */
const isNoWord = (value:string) :boolean => /^[^A-Za-z]*$/g.test(value)

/**
 * 验证中文和数字
 * @param { string} value
 */
const isCHNAndEN = (value:string) :boolean =>
  /^((?:[\u3400-\u4DB5\u4E00-\u9FEA\uFA0E\uFA0F\uFA11\uFA13\uFA14\uFA1F\uFA21\uFA23\uFA24\uFA27-\uFA29]|[\uD840-\uD868\uD86A-\uD86C\uD86F-\uD872\uD874-\uD879][\uDC00-\uDFFF]|\uD869[\uDC00-\uDED6\uDF00-\uDFFF]|\uD86D[\uDC00-\uDF34\uDF40-\uDFFF]|\uD86E[\uDC00-\uDC1D\uDC20-\uDFFF]|\uD873[\uDC00-\uDEA1\uDEB0-\uDFFF]|\uD87A[\uDC00-\uDFE0])|(\d))+$/g.test(value)
/**
 * 验证邮政编码(中国)
 * @param { string } value
 */
 ...
 * @param { string } value
 */
const isWeChatNum = (value:string) :boolean => /^[a-zA-Z][-_a-zA-Z0-9]{5,19}$/g.test(value)

/**
 * 验证16进制颜色
 * @param { string } value
 */
const isColor16 = (value:string) :boolean => /^#?([a-fA-F0-9]{6}|[a-fA-F0-9]{3})$/g.test(value)

/**
 * 验证火车车次
 * @param { string } value
 */
const isTrainNum = (value:string) :boolean => /^[GCDZTSPKXLY1-9]\d{1,4}$/g.test(value)

/**
 * 验证必须带端口号的网址(或ip)
 * @param { string } value
 */
const isHttpAndPort = (value:string) :boolean =>
 ...
 *  @param { string } value
 */
const isRightWebsite = (value:string) :boolean =>
 ...
 *  @param { string } value
 */
const isCreditCode = (value:string) :boolean =>
 ...
 *  @param { string } value
 */
const isVersion = (value:string) :boolean => /^\d+(?:\.\d+){2}$/g.test(value)
...
const isImageUrl = (value:string) :boolean =>
  /^https?:\/\/(.+\/)+.+(\.(gif|png|jpg|jpeg|webp|svg|psd|bmp|tif))$/g.test(
    value
  )
 ...
 * @param { string } value
 */
const isChineseName = (value:string) :boolean => /^(?:[\u4e00-\u9fa5·]{2,16})$/g.test(value)

/**
 * 验证英文姓名
 * @param { string } value
 */
const isEnglishName = (value:string) :boolean =>
 ...
 * @param { string } value
 */
const isLicensePlateNumberNER = (value:string) :boolean =>
 ...
 * @param { string } value
 */
const isLicensePlateNumberNNER = (value:string) :boolean =>
 ...
 * @param { string } value
 */
const isLicensePlateNumber = (value:string) :boolean =>
 ...
 * @param { string } value
 */
const isMPStrict = (value:string) :boolean =>
 ...
 * @param { string } value
 */
const isMPRelaxed = (value:string) :boolean => /^(?:(?:\+|00)86)?1[3-9]\d{9}$/g.test(value)
 ...
 * @param { string } value
 */
const isLandlineTelephone = (value:string) :boolean => /\d{3}-\d{8}|\d{4}-\d{7}/g.test(value)
 ...
 * @param { string } value
 */
const isChineseCharacter = (value:string) :boolean =>
 ...
 * @param { string } value
 */
const isDecimal = (value:string) :boolean => /^\d+\.\d+$/g.test(value)
 ...
 * @param { string } value
 */
const isNumberStr = (value:string) :boolean => /^\d{1,}$/g.test(value)
 ...
 * @param { string } value
 */
const isQQNum = (value:string) :boolean => /^[1-9][0-9]{4,10}$/g.test(value)

/**
 * 验证数字和字母组成
 * @param { string } value
 */
const isNumAndStr = (value:string) :boolean => /^[A-Za-z0-9]+$/g.test(value)

/**
 * 验证英文字母
 * @param { string } value
 */
const isEnglish = (value:string) :boolean => /^[a-zA-Z]+$/g.test(value)

/**
 * 验证大写英文字母
 * @param { string } value
 */
const isCapital = (value:string) :boolean => /^[A-Z]+$/g.test(value)

/**
 * 验证小写英文字母
 * @param { string } value
 */
const isLowercase = (value:string) :boolean => /^[a-z]+$/g.test(value)

/**
 * 验证手机机身码(IMEI)
 * @param { string } value
 */
const isIMEI = (value:string) :boolean => /^\d{15,17}$/g.test(value)

/**
 * 验证统一社会信用代码(宽松匹配)(15位/18位/20位数字/字母)
 * @param { string } value
 */
const isCreditCode2 = (value:string) :boolean =>
 ...
 * @param { string } value
 */
const isXunleiUrl = (value:string) :boolean => /^thunderx?:\/\/[a-zA-Z\d]+=$/g.test(value)

/**
 * 验证ed2k链接(宽松匹配)
 * @param { string } value
 */
const isEd2kUrl = (value:string) :boolean => /^ed2k:\/\/\|file\|.+\|\/$/g.test(value)

/**
 * 验证磁力链接
 * @param { string } value
 */
const isMagnetUrl = (value:string) :boolean =>
 ...
 * @param { string } value
 */
const isMask = (value:string) :boolean =>
 ...
 * @param { string } value
 */
const isLinuxHiddenPath = (value:string) :boolean => /^\/(?:[^/]+\/)*\.[^/]*/g.test(value)

/**
 * 验证linux文件夹路径
 * @param { string } value
 */
const isLinuxFolderPath = (value:string) :boolean => /^\/(?:[^/]+\/)*$/g.test(value)

/**
 * 验证linux文件路径
 * @param { string } value
 */
const isLinuxFilePath = (value:string) :boolean => /^\/(?:[^/]+\/)*[^/]+$/g.test(value)

/**
 * 验证window"文件夹"路径
 * @param { string } value
 */
const isWindowFolderPath = (value:string) :boolean => /^[a-zA-Z]:\\(?:\w+\\?)*$/g.test(value)

/**
 * 验证window文件路径
 * @param { string } value
 */
const isWindowFilePath = (value:string) :boolean =>
 ...
 * @param { string } value
 */
const isStockCode = (value:string) :boolean =>
 ...
 * @param { string } value
 */
const isHtmLComment = (value:string) :boolean => /^<!--[\s\S]*?-->$/g.test(value)

/**
 * 验证md5格式(32位)
 * @param { string } value
 */
const isMd532 = (value:string) :boolean => /^([a-f\d]{32}|[A-F\d]{32})$/g.test(value)
 ...
 * @param { string } value
 */
const is24HourTime = (value:string) :boolean =>
 ...
 * @param { string } value
 */
const is12HourTime = (value:string) :boolean =>
 ...
 * @param { string } value
 */
const isCurrency = (value:string) :boolean => /^-?\d+(,\d{3})*(\.\d{1,2})?$/g.test(value)

/**
 * 验证数字/货币金额 (只支持正数、不支持校验千分位分隔符)
 * @param { string } value
 */
const isCurrency2 = (value:string) :boolean =>
 ...
 * @param { string } value
 */
const isBankCard = (value:string) :boolean => /^[1-9]\d{9,29}$/g.test(value)
 ...
 * @param { string } value
 */
const isIdCard1 = (value:string) :boolean =>
 ...
 * @param { string } value
 */
const isIdCard2 = (value:string) :boolean =>
 ...
 * @param { string } value
 */
const isAccount = (value:string) :boolean => /^[a-zA-Z]\w{4,15}$/g.test(value)

/**
 * 验证html标签(宽松匹配)
 * @param { string } value
 */
const isHtmlTag = (value:string) :boolean => /<(\w+)[^>]*>(.*?<\/\1>)?/g.test(value)

/**
 * 验证用户名校验，4到16位（字母，数字，下划线，减号）
 * @param { string } value
 */
const isUsername = (value:string) :boolean => /^[a-zA-Z0-9_-]{4,16}$/g.test(value)
 ...
 * @param { string } value
 */
const isJvavaPackName = (value:string) :boolean =>
 ...
 * @param { string } value
 */
const isHKIdCard = (value:string) :boolean => /^[a-zA-Z]\d{6}\([\dA]\)$/g.test(value)

/**
 * 验证澳门身份证
 * @param { string } value
 */
const isMacauIdCard = (value:string) :boolean => /^[1|5|7]\d{6}[(\d)]{3}$/g.test(value)

/**
 * 验证台湾身份证
 * @param { string } value
 */
const isTWIdCard = (value:string) :boolean => /^[a-zA-Z][0-9]{9}$/g.test(value)
